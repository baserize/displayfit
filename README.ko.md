...
- **네이티브 Settings와 로그인 시 실행**  
  표준 macOS Settings 창에서 Full 밝기 기준과 로그인 시 실행을 설정합니다.
...
- **Icon Composer 앱 아이콘**  
  Apple의 `.icon` 패키지 포맷을 사용하고 Xcode가 앱 아이콘으로 컴파일합니다.

## 설치

GitHub 최신 릴리즈에서 `Full-Brightness-2026.05.07.001.zip`을 내려받아 압축을 풀고, `Full Brightness.app`을 `/Applications`로 옮깁니다.
...
공개 GitHub 릴리즈 태그는 날짜 기반 버전 `2026.05.07.001`을 사용합니다.
